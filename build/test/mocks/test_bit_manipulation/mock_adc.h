...
#define adc_read_Ignore() TEST_FAIL_MESSAGE("adc_read requires _IgnoreAndReturn");
...
#define adc_read_Expect() TEST_FAIL_MESSAGE("adc_read requires _ExpectAndReturn");
